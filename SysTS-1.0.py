...
for data_id in data_ids:
    ...
    #pour éviter les erreurs 429 [A MODIFIER SI TROP D'ERREURS 429]
    time.sleep(0.060)
...
print("Nombre d'exports échoués : "+str(eh))
if eh>0:
    print("Aide :\n- erreur 400 : le serveur demandé n'existe pas : erreur dans l'adresse internet\n- erreur 403 : le serveur demandé refuse l'accès : possible erreur dans le token\n- erreur 425 : pas de données actuellement : réésayez plus tard\n- erreur 429 : trop de demandes en peu de temps : augmentez le délai entre chaque demande faite par le programme")
